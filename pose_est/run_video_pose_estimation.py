...
if __name__ == "__main__":
  ...
  # allocate the device for the model
  ...
  capture = cv2.VideoCapture('./images/gyuhong2.mp4')
  ...
  while capture.isOpened():
      ...
      skeleton_img = draw_skeleton_per_person(img, output["keypoints"], output["keypoints_scores"], output["scores"],keypoint_threshold=3,linewith=2)
